...
const HTTP_ROUTES: &[HttpRoute] = &[
    ...
    HttpRoute::dual_token(
        ...
        "account",
        "wallet.ledgerEntries.allocations.list",
    ),
    HttpRoute::dual_token(
        HttpMethod::Get,
        "/app/v3/api/wallet/points/summary",
        "account",
        "wallet.points.summary.retrieve",
    ),
    HttpRoute::dual_token(
        HttpMethod::Get,
        "/app/v3/api/wallet/points/lots",
        "account",
    ...
    HttpRoute::dual_token(
        ...
        "account",
        "tokenBank.account.retrieve",
    ),
    HttpRoute::dual_token(
        HttpMethod::Get,
        "/app/v3/api/token_bank/overview",
        "account",
        "tokenBank.overview.retrieve",
    ),
    HttpRoute::dual_token(
        HttpMethod::Get,
        "/app/v3/api/token_bank/ledger_entries",
        "account",
        "tokenBank.ledgerEntries.list",
    ),
    HttpRoute::dual_token(
        HttpMethod::Get,
        "/app/v3/api/token_bank/holds",
        "account",
        "tokenBank.holds.list",
    ),
    HttpRoute::dual_token(
        HttpMethod::Get,
        "/app/v3/api/wallet/portfolio",
        "account",
        "retrieveWalletPortfolio",
    ),
];
