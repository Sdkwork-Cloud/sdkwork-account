...
const HTTP_ROUTES: &[HttpRoute] = &[
    HttpRoute::dual_token(
        ...
        "account",
        "wallet.health.retrieve",
    ),
    HttpRoute::dual_token(
        HttpMethod::Post,
        "/backend/v3/api/wallet/outbox/dispatch",
        "account",
        "wallet.outbox.dispatch",
    ),
    HttpRoute::dual_token(
        HttpMethod::Post,
    ...
    HttpRoute::dual_token(
        ...
        "account",
        "wallet.points.lots.expire",
    ),
    HttpRoute::dual_token(
        HttpMethod::Post,
        "/backend/v3/api/wallet/points/reconciliation",
        "account",
        "wallet.points.reconciliation",
    ),
    HttpRoute::dual_token(
        HttpMethod::Post,
