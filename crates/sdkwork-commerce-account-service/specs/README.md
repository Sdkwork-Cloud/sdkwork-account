...
This directory is the local standards index for `sdkwork_commerce_account_service`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-commerce-account-service` |
| Type | `rust-crate` |
| Root | `sdkwork-commerce/crates/sdkwork-commerce-account-service` |
| Domain | `commerce` |
| Capability | `commerce` |
| Languages | `rust` |
| Status | `stable` |
