...
This README is the SDKWork module entrypoint for `sdkwork-commerce-account-service`. The machine-readable component contract is `specs/component.spec.json`; canonical standards are under `../../../sdkwork-specs/`.
...
- `cargo test --manifest-path crates/sdkwork-commerce-account-service/Cargo.toml`
