...
```bash
npm install @sdkwork/account-app-sdk
# or
yarn add @sdkwork/account-app-sdk
# or
pnpm add @sdkwork/account-app-sdk
```

## Quick Start

```typescript
import { SdkworkAccountAppClient } from '@sdkwork/account-app-sdk';

const client = new SdkworkAccountAppClient({
...
```typescript
import { SdkworkAccountAppClient, NetworkError, TimeoutError, AuthenticationError } from '@sdkwork/account-app-sdk';
