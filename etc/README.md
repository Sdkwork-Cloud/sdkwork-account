# sdkwork-account Source Configuration
...
| Item | Value |
| --- | --- |
| `appId` | `sdkwork-account` |
| `runtimeCode` | `account` |
| Config root | `/etc/sdkwork/account/` |
| Runtime TOML | `/etc/sdkwork/account/config.toml` |
| Secrets | `/etc/sdkwork/account/secrets/` |
| Override | `SDKWORK_ACCOUNT_CONFIG_FILE` |
