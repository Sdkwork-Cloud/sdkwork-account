...
Module `sdkwork-account` · runtime code `account` · enabled
...
| --- | --- | ---: | --- | --- |
| development | `server.development.toml` | 16 | `account-dev.sdkwork.com` | 80 |
| test | `server.test.toml` | 16 | `account-test.sdkwork.com` | 80 |
| staging | `server.staging.toml` | 16 | `account-staging.sdkwork.com` | 80 |
| demo | `server.demo.toml` | 16 | `account-demo.sdkwork.com` | 80 |
| production | `server.production.toml` | 16 | `account.sdkwork.com` | 443 ssl + 80 |
