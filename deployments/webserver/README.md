...
| --- | --- | ---: | --- | --- |
| development | `server.development.toml` | 14 | `account-dev.sdkwork.com` | 80 |
| test | `server.test.toml` | 14 | `account-test.sdkwork.com` | 80 |
| staging | `server.staging.toml` | 14 | `account-staging.sdkwork.com` | 80 |
| demo | `server.demo.toml` | 14 | `account-demo.sdkwork.com` | 80 |
| production | `server.production.toml` | 14 | `account.sdkwork.com` | 443 ssl + 80 |
