...
CREATE INDEX IF NOT EXISTS idx_commerce_account_transfer_from_created
    ON commerce_account_transfer (tenant_id, from_account_id, created_at);
CREATE INDEX IF NOT EXISTS idx_commerce_account_transfer_to_created
    ON commerce_account_transfer (tenant_id, to_account_id, created_at);
...
CREATE INDEX IF NOT EXISTS idx_commerce_token_bank_exchange_rate_lookup
    ON commerce_token_bank_exchange_rate (tenant_id, from_currency_code, channel, tenant_scope, status, effective_from);
...
CREATE INDEX IF NOT EXISTS idx_commerce_token_bank_exchange_quote_owner
    ON commerce_token_bank_exchange_quote (tenant_id, owner_type, owner_id, status, created_at);
...
CREATE INDEX IF NOT EXISTS idx_commerce_token_bank_exchange_snapshot_account
    ON commerce_token_bank_exchange_snapshot (tenant_id, account_id, created_at);
...
CREATE INDEX IF NOT EXISTS idx_commerce_token_bank_settlement_snapshot_account
    ON commerce_token_bank_settlement_snapshot (tenant_id, account_id, created_at);
...
CREATE INDEX IF NOT EXISTS idx_commerce_token_bank_settlement_snapshot_service
    ON commerce_token_bank_settlement_snapshot (tenant_id, service_account_id, created_at);
...
CREATE INDEX IF NOT EXISTS idx_commerce_billing_history_owner_occurred
    ON commerce_billing_history (tenant_id, owner_type, owner_id, occurred_at);
